...
public class Torchelight : MonoBehaviour {
	...
	void Start () {
		...
		ParticleSystemExtension.SetEmissionRate(MainFlame.GetComponent<ParticleSystem>(),IntensityLight*20f);
		ParticleSystemExtension.SetEmissionRate(BaseFlame.GetComponent<ParticleSystem>(),IntensityLight*15f);
		ParticleSystemExtension.SetEmissionRate(Etincelles.GetComponent<ParticleSystem>(),IntensityLight*7f);
		ParticleSystemExtension.SetEmissionRate(Fumee.GetComponent<ParticleSystem>(),IntensityLight*12f);
