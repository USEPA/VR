...
namespace HurricaneVR.Framework.Core.Player
{
    public abstract class HVRScreenFade : MonoBehaviour
    {
        ...
        public bool Active { get { return (_coroutine != null); } }
        ...
        {
            FadeStart.Invoke();
            //UnityEngine.Debug.Log($"{gameObject.name} started fade: {fadeLevel} || Time: {Time.time}");
            ...
            FadeEnd.Invoke();
            //UnityEngine.Debug.Log($"{gameObject.name} ended fade: {fadeLevel} || Time: {Time.time}");
            _coroutine = null;
        }
